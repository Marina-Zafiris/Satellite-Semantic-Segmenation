# %% [markdown]
# # Simple U-Net to segment fire scars
# Important remarks:
# -  Based on simple U-Net for cloud detection, https://arxiv.org/pdf/1901.10077.pdf
...
# %% [code]
base_path = Path('../input/firescars/training_data')
...
# %% [code]
train_ds, valid_ds = torch.utils.data.random_split(data, (1500, 511))
